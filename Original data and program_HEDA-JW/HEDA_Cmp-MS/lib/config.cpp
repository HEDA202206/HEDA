...
void ConfigParameter_TSEDA() {
    Parameter_TSEDA.NumOfChromPerPop = Tasks.size() * 2;
    if (Parameter_TSEDA.NumOfChromPerPop % 2 == 1) {
        ++Parameter_TSEDA.NumOfChromPerPop;
    }
    Parameter_TSEDA.theta = 0.15;
//    Parameter_TSEDA.theta2 = 0.25;
    Parameter_TSEDA.eta = 3.5;
    Parameter_TSEDA.NumOfEliteOfPop =  ceil(Parameter_TSEDA.NumOfChromPerPop * 0.05);
    Parameter_TSEDA.NumOfImproveOfPop = ceil(Parameter_TSEDA.NumOfChromPerPop * 0.2);
    Parameter_TSEDA.RunTimeRatioOfStg1 = 0.7;
}

void ConfigParameter_HEDA() {
    Parameter_HEDA.NumOfChromPerPop = Tasks.size() * 3.5;
    if (Parameter_HEDA.NumOfChromPerPop % 2 == 1) {
        ++Parameter_HEDA.NumOfChromPerPop;
    }
    Parameter_HEDA.theta1 = 0.04;
    Parameter_HEDA.theta2 = 0.02;
    Parameter_HEDA.eta = 1.5;
    Parameter_HEDA.prp = 0.5;
    Parameter_HEDA.RunTimeRatioOfStg1 = 0.75;
}
