...
//    TaskCombine();
    ...
    chromosome Chrom_EFT_b = GnrPrtByRank_EFT(Rank_b1);
    population.push_back(Chrom_EFT_b);
    chromosome Chrom_EFT_t = GnrPrtByRank_EFT(Rank_t);
    population.push_back(Chrom_EFT_t);
    ...
    int terminationNum = ceil(500 * ModelScale/sqrt(comConst.NumOfTsk)/Parameter_HPSO.NumOfChromPerPop); double TotalNum = terminationNum;
