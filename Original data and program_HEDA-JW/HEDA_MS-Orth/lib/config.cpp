...
void ConfigParameter_HEDA(Orthogonal orthogonal) {
    Parameter_HEDA.NumOfChromPerPop = Tasks.size() * orthogonal.PopSizeFactor;
    if (Parameter_HEDA.NumOfChromPerPop % 2 == 1) {
        ++Parameter_HEDA.NumOfChromPerPop;
    }
    Parameter_HEDA.theta1 = orthogonal.theta1;
    Parameter_HEDA.theta2 = orthogonal.theta2;
    Parameter_HEDA.eta = orthogonal.eta;
    Parameter_HEDA.prp = orthogonal.prp;
    Parameter_HEDA.RunTimeRatioOfStg1 = orthogonal.RunTimeRatioOfStg1;
}
